...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden" style={{ backgroundColor: '#090014' }}>
      <div className="container-base pt-16 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-[240px_1fr_1fr_1fr] gap-8 mb-12">

          {/* Brand */}
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="rounded-xl overflow-hidden shrink-0" style={{ width: 40, height: 40 }}>
                <img src="/logo-dark.png" alt="Danapp Edge" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="flex gap-2">
              <SocialIcon href="#">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 4.557a9.83 9.83 0 01-2.828.775 4.932 4.932 0 002.165-2.724 9.864 9.864 0 01-3.127 1.195 4.916 4.916 0 00-8.384 4.482A13.944 13.944 0 011.64 3.161a4.916 4.916 0 001.523 6.561 4.9 4.9 0 01-2.23-.616v.061a4.916 4.916 0 003.946 4.816 4.936 4.936 0 01-2.224.085 4.918 4.918 0 004.6 3.417A9.867 9.867 0 010 19.54a13.94 13.94 0 007.548 2.212c9.057 0 14.01-7.503 14.01-14.01 0-.213-.005-.425-.014-.636A10.012 10.012 0 0024 4.557z" />
                </svg>
              </SocialIcon>
              <SocialIcon href="#">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-sm font-bold mb-4" style={{ color: '#FFFFFF' }}>Navigation</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-bold mb-4" style={{ color: '#FFFFFF' }}>Contact</h4>
            <ul className="space-y-3">
              <li>
                <a
      ...
      <div className="overflow-hidden" style={{ marginBottom: -4 }}>
        <p
          className="font-black pointer-events-none select-none leading-none text-center w-full"
          style={{
            fontSize: '14vw',
            color: '#FFFFFF',
            opacity: 0.04,
